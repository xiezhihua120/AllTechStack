 ...
 */
package com.longtech.taskmanager.practice.core.schedulers.main;
...
public final class AndroidSchedulers {
    ...
    private static final class MainHolder {
        static final Scheduler MAIN_THREAD = new HandlerScheduler(new Handler(Looper.getMainLooper()), true);
    }

    public static Scheduler mainThread() {
        return MainHolder.MAIN_THREAD;
    }

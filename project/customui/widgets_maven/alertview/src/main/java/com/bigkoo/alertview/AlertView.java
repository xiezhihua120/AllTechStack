...
public class AlertView {
    ...
    public AlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, int gravity, OnItemClickListener onItemClickListener) {
        this.context = context;
        if (style != null){
            this.style = style;
        }
...
//        decorView = (ViewGroup) ((Activity) context).getWindow().getDecorView().findViewById(android.R.id.content);
    ...
    protected void initHeaderView(ViewGroup viewGroup) {
        ...
        if (title != null) {
            ...
            tvAlertTitle.setVisibility(View.INVISIBLE);
            tvAlertTitle.setPadding(0,context.getResources().getDimensionPixelSize(R.dimen.marginBottom_alert_msg),0,0);
        }
        if (msg != null) {
...
//            tvAlert.setTypeface(Typeface.DEFAULT_BOLD);
            tvAlert.setTextColor(context.getResources().getColor(R.color.bg_longtech_mian_color));

package com.longtech.services.interceptor
...
import com.longtech.services.ARouterConst
...
class LoginInterceptor : IInterceptor {
    ...
    override fun process(postcard: Postcard, callback: InterceptorCallback) {
        ...
        var needLogin = bundle?.getBoolean(ARouterConst.NEED_LOGIN_EXTRA)
        if (needLogin == true || extra == ARouterConst.NEED_LOGIN_FLAG) {
